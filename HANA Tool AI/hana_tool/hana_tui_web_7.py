...
<!-- Header -->
<div id="header">
  <div class="logo">SAP HANA <span>SQL Console</span> <small>v5.0</small></div>
...
<div id="about-overlay" onclick="if(event.target===this)hideAbout()">
  <div id="about-box">
    ...
    <div class="about-version">Version 5.0</div>
    <hr/>
    <div class="about-row"><span class="lbl">Version</span><span class="val">5.0</span></div>
...
if __name__ == "__main__":
    ...
    print(f"HANA SQL Console v5.0 running at {url}  (Ctrl+C to stop)")
